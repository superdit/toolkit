...
var uploadTests = []struct {
	...
	{name: "allowed no rename", alowedTypes: []string{"image/jpeg", "image/png"}, renameFile: false, errorExpected: false},
	{name: "allowed rename", alowedTypes: []string{"image/jpeg", "image/png"}, renameFile: true, errorExpected: false},
	{name: "not allowed", alowedTypes: []string{"image/jpeg"}, renameFile: false, errorExpected: true},
}
...
func TestTools_UploadFiles(t *testing.T) {
	for _, e := range uploadTests {
		...
		var testTools Tools
		testTools.AllowedFileTypes = e.alowedTypes
...
var slugTests = []struct {
	...
	{name: "japanese string and roman character", s: "hello world こんにちは世界", expected: "hello-world", errorExpected: true},
}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	testTool.DownloadStaticFile(rr, req, "./testdatapic.jpg", "puppy.jpg")
...
func TestTools_ErrorJSON(t *testing.T) {
	...
	if !payload.Error {
		t.Error("erro set to false in JSON, and it should be true")
	}
